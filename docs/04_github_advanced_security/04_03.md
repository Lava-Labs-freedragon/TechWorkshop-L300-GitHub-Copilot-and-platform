...
2. You will see findings from the `ZavaStorefront.csproj` file. If you select the finding you'll see a recommendation to update from .NET 6 to the latest LTS version (currently .NET 10).
